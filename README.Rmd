...
> `/simulation`: R files for different simulation settings (*see details about the simulation design in my paper Section 5*)
  ...
  + `Setting_III`: Setting III (*The corresponding results shown in the Supplementary Materials*)
  + `Setting_IV`: Setting IV (*The corresponding results shown in the Supplementary Materials*)
  + `Setting_SUPP`: A supplementary simulation setting (*The corresponding results shown in the Supplementary Materials*)
